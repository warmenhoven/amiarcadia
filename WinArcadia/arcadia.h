...
EXPORT const UBYTE arcadia_pdg[2][66][8] =
...
EXPORT const TEXT arcadia_chars[64 + 1] =
" /\\#il_jwqasrtgf0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ.,+$zxcvbnmh";

MODULE const UBYTE sprnumbers[4][8] = {
{ 0xFF, // ########
  0xE7, // ###..###
  0xDB, // ##.##.##
  0xDB, // ##.##.##
